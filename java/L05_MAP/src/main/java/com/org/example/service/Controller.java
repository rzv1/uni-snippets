...
public class Controller {
    ...
    public void addFriendship(Long id, Long user1Id, Long user2Id) throws EntityNotFoundException, FileNotFoundException {
        fService.add(id, user1Id, user2Id);
    }

    public void removeUser(Long id) throws EntityNotFoundException, FileNotFoundException {
        userService.remove(id);
    }

    public void removeFriendship(Long id) throws EntityNotFoundException, FileNotFoundException, FriendshipNotFoundException {
        fService.remove(id);
    }
