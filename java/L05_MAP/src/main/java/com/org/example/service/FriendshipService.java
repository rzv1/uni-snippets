...
public class FriendshipService {
    ...
    public void add(Long id, Long user1Id, Long user2Id) throws EntityNotFoundException, FileNotFoundException {
    ...
    public void remove(Long id) throws EntityNotFoundException, FileNotFoundException, FriendshipNotFoundException {
        fRepo.remove(id);
    }
